...
import { faBed, faCalendarDays, faGlobe, faHouse, faLocationDot, faSink, faTag } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className='d-flex content-main-detailmaison container '>
        <div className='one-img-left' >
          <div className='img-main-detail-maison'>
            <Image  src={maisonDetails && maisonDetails.image} className='content-img-detail-maison1' />
          </div>
        ...
        <div className='second-img-right1'>
          ...
          <p>{maisonDetails && maisonDetails.description}</p>
             <div className='d-flex justify-content-evenly'>
              <div>
                <div><span><FontAwesomeIcon icon={faGlobe} id='icon-details-right' /></span><span>{maisonDetails && maisonDetails.superficie} m2</span></div>
                <div><span><FontAwesomeIcon icon={faTag} id='icon-details-right' /></span><span>{maisonDetails && maisonDetails.prix} FCFA</span></div>
                <div><span><FontAwesomeIcon icon={faLocationDot} id='icon-details-right' /></span><span>{maisonDetails && maisonDetails.addresse}</span></div>
              </div>
              <div>
              <div><span><FontAwesomeIcon icon={faHouse} id='icon-details-right' /></span> Categorie:
                        ...
                        <div></div>
                       <div><span><FontAwesomeIcon icon={faCalendarDays} id='icon-details-right' /></span><span> Date construction:{" "}
                            {maisonDetails.annee_construction}</span></div>
